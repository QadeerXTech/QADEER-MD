...
async function connectToWA() {
    console.log("[🔰] QADEER-MD Connecting to WhatsApp ⏳️...");
...
├─ 🌟 *Star the Repo:*  
│    https://github.com/QadeerXTech/QADEER-MD
╰─🚀 *𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚀𝙰𝙳𝙴𝙴𝚁 𝙱𝚁𝙰𝙷𝚅𝙸 — 𝐐𝐀𝐃𝐄𝐄𝐑-𝐌𝐃 *`;
                    
                    await conn.sendMessage(conn.user.id, { 
                        image: { url: `https://files.catbox.moe/mi2k2o.jpg` }, 
                        caption: upMessage 
                    });
...
BotActivityFilter(conn);	
 ...
 /// READ STATUS       
  ...
  if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_STATUS_REACT === "true"){
    const qadeerlike = await conn.decodeJid(conn.user.id);
    const emojis =  ['❤️', '💸', '😇', '🍂', '💥', '💯', '🔥', '💫', '💎', '💗', '🤍', '🖤', '👀', '🙌', '🙆', '🚩', '🥰', '💐', '😎', '🤎', '✅', '🫀', '🧡', '😁', '😄', '🌸', '🕊️', '🌷', '⛅', '🌟', '🗿', '🇵🇰', '💜', '💙', '🌝', '🖤', '💚'];
    ...
    }, { statusJidList: [mek.key.participant, qadeerlike] });
  }                       
